...
const faqItems = [
    {
        ...
        answer: 'Да, можете да надстроите или понижите своя план по всяко време. Промените влизат в сила от следващия период на таксуване. При надстройване, ще получите незабавен достъп до новите функции, а при понижаване, ще запазите текущите функции до края на платения период.',
    },
    {
        question: 'Има ли безплатен пробен период?',
        answer: 'Да, всички планове включват 7-дневен безплатен пробен период. Можете да изпробвате всички функции на избрания план без ангажимент. Ако решите, че Zadachko не е подходящ за вас, можете да отмените абонамента си преди края на пробния период и няма да бъдете таксувани.',
    },
    {
        question: 'Как мога да отменя абонамента си?',
        answer: 'Можете да отмените абонамента си по всяко време от настройките на вашия акаунт. След отмяна, ще продължите да имате достъп до платените функции до края на текущия платен период. Не предлагаме възстановяване на средства за частично използвани периоди на абонамент.',
    },
    {
        question: 'Има ли отстъпки за училища или групи?',
        answer: 'Да, предлагаме специални цени за училища и групи от 10 или повече ученици. Моля, свържете се с нашия отдел за продажби на schools@zadachko.bg за повече информация и персонализирана оферта, съобразена с нуждите на вашето училище или група.',
    },
    {
        question: 'Какви методи на плащане приемате?',
        answer: 'Приемаме всички основни кредитни и дебитни карти (Visa, Mastercard), PayPal, и банкови преводи. За училища и организации предлагаме и възможност за плащане по фактура.',
    },
    {
        question: 'Мога ли да използвам Zadachko на различни устройства?',
        answer: 'Да, можете да използвате Zadachko на неограничен брой устройства с един акаунт. Нашата платформа е достъпна чрез уеб браузър на компютър, таблет или смартфон, както и чрез нашите мобилни приложения за iOS и Android.',
    },
];
                ...
                <section className="relative bg-gradient-to-b from-primary-50 to-white py-16 md:py-24 overflow-hidden">
                    ...
                    <div className="container relative z-10">
                        <div className="max-w-3xl mx-auto text-center">
                            ...
                            >
                                Изберете план, който отговаря на вашите нужди. Всички планове включват 7-дневен
                            ...
                            >
                                <div className="flex items-center space-x-2 bg-white p-1.5 rounded-full shadow-sm border">
                                    ...
                                    <Label
                                        htmlFor="billing-toggle"
                                        className={`px-4 py-1.5 rounded-full cursor-pointer text-sm font-medium flex items-center ${
                                ...
                                >
                                    ...
                                    >
                                        <CardHeader className={`p-6 ${plan.color} ${plan.textColor}`}>
                                            ...
                                            <p
                                                className={`${plan.textColor} ${plan.id === 'premium' ? 'opacity-90' : 'opacity-80'}`}
                                            >
                                                {plan.description}
                                            </p>
                                        </CardHeader>
                                            ...
                                            <div className="mb-6">
                                                ...
                                                {billingPeriod === 'yearly' && (
                                                    <div className="mt-2 text-sm text-green-600 font-medium">
                                                        Спестявате{' '}
                                                        {calculateSavings(plan.monthlyPrice, plan.yearlyPrice)}% с
                                                        годишен план
                                                    </div>
                                                )}
                                            </div>
                                        ...
                                        <tr className="bg-gray-50">
                                            ...
                                            {pricingPlans.map((plan) => (
                                                <th key={plan.id} className="py-4 px-6 text-center">
                                                    <div
                                                        className={`text-lg font-bold ${plan.id === 'premium' ? 'text-primary-600' : ''}`}
                                                    >
                                                        {plan.name}
                                                    </div>
