...
const faqItems = [
    {
        question: "Как мога да започна да използвам Задачко?",
        answer:
            "Просто се регистрирай с имейл адрес и парола, избери подходящия план за теб и започни да решаваш задачи веднага. Имаме безплатен план за начинаещи.",
    },
    {
        question: "Подходяща ли е платформата за ученици в 7 клас?",
        answer:
            "Да, Задачко е специално създадена за ученици в 7 клас, които се подготвят за НВО по математика. Всички задачи и материали са адаптирани към учебната програма.",
    },
    {
        question: "Мога ли да използвам платформата на мобилен телефон?",
        answer:
            "Абсолютно! Задачко е напълно оптимизирана за мобилни устройства. Можеш да учиш и решаваш задачи от телефона си, таблета или компютъра.",
    },
    {
        question: "Какво включва премиум планът?",
        answer:
            "Премиум планът включва достъп до всички задачи, персонализирани тестове, детайлна статистика, видео обяснения и приоритетна поддръжка.",
    },
    {
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:support@zadachko.bg" className="text-primary hover:underline">
                                            support@zadachko.bg
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">Онлайн всеки ден 9:00 - 18:00</p>
                                    </div>
                                </div>
                            </div>
                        </motion.div>
