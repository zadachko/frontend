...
import { AssessmentResults } from './AssessmentOverview';
import AssessmentOverview from './AssessmentOverview';
import type * as ExamColors from '../../exam/colors.config';
import type * as TestColors from '../../test/colors.config';
...
const AssessmentIdProvider = ({ colors }: { colors: AssessmentColors }) => {
...
export default AssessmentIdProvider;