                                ...
                                <CardContent className="pt-6 space-y-6">
                                    ...
                                    <div className="p-4 bg-primary-50 rounded-lg">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Редовната практика на малки порции от по 15-20 минути е по-ефективна от
                                            дългите сесии веднъж седмично.
                                        </p>
                                    </div>
                                    ...
                                    <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-100">
                                        ...
                                        <p className="text-sm text-gray-600">
                                            Използвай бутона <span className="font-bold">Покажи решение</span> за да
                                            видиш подробно обяснение на всяка задача.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
