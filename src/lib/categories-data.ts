...
export const categoriesData: Category[] = [
	{
		...
		name: 'Алгебра',
		description:
			'Научи основите на алгебрата с уравнения, променливи и математически изрази',
		icon: Calculator,
		...
		subcategories: [
			{
				...
				name: 'Основни изрази',
				description:
					'Научи как да работиш с променливи и прости алгебрични изрази',
		...
		subcategories: [
			{
				...
				name: 'Основни фигури',
				description:
					'Научи за триъгълници, квадрати, кръгове и техните свойства',
			...
			},
			{
				...
				name: 'Ъгли',
				description:
					'Разбери различните видове ъгли и как да ги измерваш',
	...
	},
	{
		...
		name: 'Предалгебра',
		description:
			'Подготви се за алгебрата с основни математически концепции',
		icon: Sigma,
		bgColor: 'bg-teal-100',
		...
		subcategories: [
			{
				...
				description:
					'Усъвършенствай уменията си с основните математически операции',
