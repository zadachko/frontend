 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation StartAssessmentSession($input: CreateAssessmentInput!) {\n  startAssessmentSession(input: $input) {\n    id\n    questions {\n      position\n      question {\n        statement\n      }\n    }\n  }\n}"): (typeof documents)["mutation StartAssessmentSession($input: CreateAssessmentInput!) {\n  startAssessmentSession(input: $input) {\n    id\n    questions {\n      position\n      question {\n        statement\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
